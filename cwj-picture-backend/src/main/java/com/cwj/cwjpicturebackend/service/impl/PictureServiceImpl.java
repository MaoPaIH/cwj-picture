...
import com.cwj.cwjpicturebackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.cwj.cwjpicturebackend.mapper.PictureMapper;
import com.cwj.cwjpicturebackend.model.dto.file.UploadPictureResult;
...
import com.cwj.cwjpicturebackend.utils.ColorSimilarUtils;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    public PictureVO uploadPicture(Object inputSource, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        if (pictureId != null) {
            ...
            // 校验空间是否一致
            // 没传 spaceId 则复用原有的值，同时也兼容了公共图库
            if (spaceId == null) {
                spaceId = oldPicture.getSpaceId();
            } else {
                // 传 spaceId 则必须和原图片的值一致
