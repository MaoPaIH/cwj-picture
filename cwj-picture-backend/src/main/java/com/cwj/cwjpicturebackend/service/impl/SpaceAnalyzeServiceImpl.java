...
import com.cwj.cwjpicturebackend.model.dto.space.analyze.*;
...
import com.cwj.cwjpicturebackend.model.vo.space.analyze.*;
import com.cwj.cwjpicturebackend.service.PictureService;
import com.cwj.cwjpicturebackend.service.SpaceAnalyzeService;
...
public class SpaceAnalyzeServiceImpl extends ServiceImpl<SpaceMapper, Space>
    ...
    private void checkSpaceAnalyzeAuth(SpaceAnalyzeRequest spaceAnalyzeRequest, User loginUser) {
        ...
        if (spaceAnalyzeRequest.isQueryAll() || spaceAnalyzeRequest.isQueryPublic()) {
            ...
            ThrowUtils.throwIf(spaceId == null || spaceId <= 0, ErrorCode.PARAMS_ERROR, "空间 ID 为空");
            Space space = spaceService.getById(spaceId);
            ThrowUtils.throwIf(space == null, ErrorCode.NOT_FOUND_ERROR, "空间不存在");
            spaceService.checkSpaceAuth(loginUser, space);
        }
